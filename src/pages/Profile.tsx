    ...
    <div className="w-full px-4 py-6 pb-[calc(5rem+var(--sab))]">
      <div className="w-full max-w-2xl mx-auto">
        <div className="text-center mb-6">
          ...
          <BottomSheet open={showEditDialog} onOpenChange={setShowEditDialog}>
            ...
            <BottomSheetContent>
              <BottomSheetHeader>
                ...
                <BottomSheetDescription>Update your profile information</BottomSheetDescription>
              </BottomSheetHeader>
              <div className="space-y-4 px-6 pb-6">
                ...
                <Button onClick={handleUpdateProfile} className="w-full touch-target" haptic="medium">
                  Save Changes
                </Button>
              </div>
            </BottomSheetContent>
